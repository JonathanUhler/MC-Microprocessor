...
function replaceStringInData(directory, search, replace) {
	...
	fs.readFile(directory, (err, data) => {
		...
		let returnData = []; // Declare the returnData string to be used later
...
// TEST CODE LINE ----------------------------------------------------------------------------
// replaceStringInData('/Users/jonathan/Documents/VS Code/Assembler/input.txt', /\/\/.*$/, "");
